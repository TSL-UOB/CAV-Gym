...
actors = [
    ...
    Car(
        init_state=DynamicActorState(
            position=utilities.Point(0.0, road_layout.main_road.outbound_lanes_bounds[1][1] + (road_layout.main_road.constants.lane_width / 2.0)),
            velocity=100.0,
            orientation=0.0,
            acceleration=0.0,
            angular_velocity=0.0
    ...
    Bicycle(
        init_state=DynamicActorState(
            position=utilities.Point(0.0, road_layout.main_road.outbound_lanes_bounds[2][1] + (road_layout.main_road.constants.lane_width / 2.0)),
            velocity=100.0,
            orientation=0.0,
            acceleration=0.0,
            angular_velocity=0.0
